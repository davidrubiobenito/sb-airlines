...
public class PassengerResponseIntoPassengerWebResponseConverterTest{
    ...
    @InjectMocks
    private PassengerResponseIntoPassengerWebResponseConverter converter;
    ...
    @Test
    public void whenPassengerResponse_shouldConvert_PassengerWebResponse(){
        when(bookingRecordWebResponseConverter.convert(passengersResponse.getBookingRecordResponse()))
                .thenReturn(bookingRecordWebResponse);
        assertThat(converter.convert(passengersResponse), is(passengersWebResponse));
    }
