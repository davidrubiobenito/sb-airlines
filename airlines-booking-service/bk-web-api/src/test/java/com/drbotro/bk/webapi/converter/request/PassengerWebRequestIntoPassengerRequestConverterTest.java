...
public class PassengerWebRequestIntoPassengerRequestConverterTest{
    ...
    @InjectMocks
    private PassengerWebRequestIntoPassengerRequestConverter converter;
    ...
    @Test
    public void whenPassengerRequest_shouldConvert_Passenger(){
        when(bookingRecordRequestConverter.convert(passengersWebRequest.getBookingRecordWebRequest()))
                .thenReturn(bookingRecordRequest);
        assertThat(converter.convert(passengersWebRequest), is(passengersRequest));
    }
