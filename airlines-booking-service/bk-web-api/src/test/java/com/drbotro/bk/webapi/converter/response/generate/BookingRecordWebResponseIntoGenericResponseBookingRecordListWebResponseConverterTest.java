...
public class BookingRecordWebResponseIntoGenericResponseBookingRecordListWebResponseConverterTest{
    ...
    @InjectMocks
    private BookingRecordWebResponseIntoGenericResponseBookingRecordListWebResponseConverter converter;
    ...
    public void setup(){
        ...
        bookingRecordWebResponse = bookingRecordWebResponse.cloneBuilder()
                .withPassengersWebResponse(passengersWebResponseList).build();
    }
    ...
    @Test
    public void whenBookingRecordWebResponse_shouldConvert_GenericBookingRecordWebResponse(){
        GenericResponseBookingRecordWebResponse genericBookingRecordWebResponse = GenericResponseBookingRecordWebResponse
                .builder().withStatus(STATUS_OK).withData(Arrays.asList(bookingRecordWebResponse)).withError(null)
                .build();

        assertThat(converter.convert(bookingRecordWebResponse), is(genericBookingRecordWebResponse));
    }
