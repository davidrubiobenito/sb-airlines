...
public class BookingRecordWebRequestTest extends AbstractModelBeanTest<BookingRecordWebRequest>{
    ...
    public void initEntities(){
        ...
        entityA1 = bookingRecordWebRequest.cloneBuilder().withPassengersWebRequest(passengersWebRequestList).build();
        entityA2 = bookingRecordWebRequest.cloneBuilder().withPassengersWebRequest(passengersWebRequestList).build();
        entityB = bookingRecordWebRequestOther.cloneBuilder().withPassengersWebRequest(passengersWebRequestOtherList)
                .build();
