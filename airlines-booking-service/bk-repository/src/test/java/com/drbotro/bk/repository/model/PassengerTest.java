...
public class PassengerTest extends AbstractModelBeanTest<Passenger>{
    ...
    public void initEntities(){
        ...
        entityA1 = Passenger.builder().withFirstname(FIRST_NAME_P1).withLastName(LAST_NAME_P1).withGender(GENDER_P1)
                .withBookingRecord(bookingRecord).build();
        entityA2 = Passenger.builder().withFirstname(FIRST_NAME_P1).withLastName(LAST_NAME_P1).withGender(GENDER_P1)
                .withBookingRecord(bookingRecord).build();
        entityB = Passenger.builder().withFirstname(FIRST_NAME_P2).withLastName(LAST_NAME_P2).withGender(GENDER_P2)
                .withBookingRecord(bookingRecordOther).build();
