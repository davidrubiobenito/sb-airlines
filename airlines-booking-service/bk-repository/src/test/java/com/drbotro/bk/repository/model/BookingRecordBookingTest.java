...
public class BookingRecordBookingTest extends AbstractModelBeanTest<BookingRecordBooking>{
    ...
    public void initEntities(){
        ...
        entityA1 = bookingRecord.cloneBuilder().withPassengers(passengersList).build();
        entityA2 = bookingRecord.cloneBuilder().withPassengers(passengersList).build();
        entityB = bookingRecordOther.cloneBuilder().withPassengers(passengersOtherList).build();
