...
public class PassengerRequestIntoPassengerConverterTest{
    ...
    @InjectMocks
    private PassengerRequestIntoPassengerConverter converter;
    ...
    public void whenPassengerRequest_shouldConvert_Passenger(){
        when(bookingRecordConverter.convert(passengersRequest.getBookingRecordRequest())).thenReturn(bookingRecord);
        assertThat(converter.convert(passengersRequest), is(passengers));
    }
