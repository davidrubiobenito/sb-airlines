...
public class BookingRecordRequest extends AbstractModelBean{
    ...
    private long bookingRecordRequestId;
    ...
    private BookingRecordRequest(BookingRecordRequestBuilder builder){
        this.bookingRecordRequestId = builder.bookingRecordRequestId;
    ...
    public long getBookingRecordRequestId(){
        return bookingRecordRequestId;
    }
    ...
    public boolean equals(Object other){
        ...
        return new EqualsBuilder().append(bookingRecordRequestId, castOther.bookingRecordRequestId)
                ...
                .append(status, castOther.status).append(passengersRequest, castOther.passengersRequest).isEquals();
    }

    @Override
    public int hashCode(){
        return new HashCodeBuilder().append(bookingRecordRequestId).append(flightNumber).append(origin)
                .append(destination).append(flightDate).append(bookingDate).append(fare).append(status)
                .append(passengersRequest).toHashCode();
    }
    ...
    public BookingRecordRequestBuilder cloneBuilder(){
        return new BookingRecordRequestBuilder().withBookingRecordRequestId(this.bookingRecordRequestId)
                ...
                .withStatus(this.status).withPassengersRequest(this.passengersRequest);
    }
    ...
    public static final class BookingRecordRequestBuilder implements IBookingRecordRequestBuilder{
        ...
        public BookingRecordRequestBuilder withBookingRecordRequestId(long bookingRecordRequestId){
            this.bookingRecordRequestId = bookingRecordRequestId;
            return self();
        }
