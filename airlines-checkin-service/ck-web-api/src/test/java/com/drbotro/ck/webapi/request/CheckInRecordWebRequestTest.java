...
public class CheckInRecordWebRequestTest extends AbstractModelBeanTest<CheckInRecordWebRequest>{
    ...
    public void initEntities(){
        entityA1 = CheckInRecordWebRequest.builder().withLastName(LAST_NAME).withFirstName(FIRST_NAME)
        ...
        entityA2 = CheckInRecordWebRequest.builder().withLastName(LAST_NAME).withFirstName(FIRST_NAME)
                .withSeatNumber(SEAT_NUMBER).withCheckInTime(CHECK_IN_TIME).withFlightNumber(FLIGHT_NUMBER)
                .withFlightDate(FLIGHT_DATE).withBookingId(BOOKING_ID).build();
        entityB = CheckInRecordWebRequest.builder().withLastName(LAST_NAME).withFirstName(FIRST_NAME)
                .withSeatNumber(SEAT_NUMBER).withCheckInTime(CHECK_IN_TIME).withFlightNumber(FLIGHT_NUMBER)
